                ...
                <el-form :inline="true" :model="searchForm" size="default">
                    <el-form-item label="标题" prop="Title">
                        <el-input v-model.trim="searchForm.Title"  placeholder="请输入标题"  :clearable="true" ></el-input>
                 		 ...
                 		 <el-select v-model="searchForm.IsPutaway" class="search-input" :clearable="true" placeholder="请选择是否显示" >
...
<!-- 编辑对话框 -->
        ...
        <!-- 数据表格 -->
        <PaginationTable ref="PaginationTableId" url="/SysNotice/List" :column="columnList" :where="where">
