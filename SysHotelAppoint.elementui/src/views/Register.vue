    ...
    <div class="login-container">
        ...
        <div class="login-shell">
            <div class="login-left">
                <img class="login-image" src="@/assets/loginbg.png" alt="注册背景图">
                ...
                <div class="login-left-content">
                    ...
                    <div class="hero-slogan">
                        <div class="hero-title">首次使用，从注册开始</div>
                        <div class="hero-desc">创建个人账号，完善基础信息后即可在线预约入住、查看订单与积分。</div>
                    </div>

                    <div class="left-bottom">
                        <div class="brand-hint">还没有账号？请先完成注册信息填写。</div>
                        <div class="left-meta" aria-hidden="true">
                            <span class="meta-chip">多角色支持</span>
                            <span class="meta-chip">信息一键保存</span>
                            <span class="meta-chip">账号安全加密</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="login-form-container">
                    <div class="login-header">
                        <div class="login-title-row">
                            ...
                            <span class="title-chip" aria-hidden="true">用户注册</span>
                        </div>
                        <div class="login-desc">请填写以下信息完成账号注册</div>
                    </div>

                    <el-form ref="registerForm" :model="formData" label-position="top" :rules="rules"
                        class="login-form">
                        ...
                        <el-form-item label="密码" prop="Password">
                            <el-input v-model="formData.Password" type="password" show-password placeholder="请输入8-16位密码"
                                clearable />
                        </el-form-item>
                        ...
                        <el-form-item class="login-actions">
                            <el-button type="primary" class="login-button" @click="registerBtn">
                                注 册
                            </el-button>
                        </el-form-item>
                    </el-form>
